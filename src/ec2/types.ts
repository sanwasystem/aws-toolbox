...
export type EC2DescribeInstancesResult = PromiseResult<AWS.EC2.DescribeInstancesResult, AWS.AWSError>;
export type EbsInstanceBlockDevice = Required<AWS.EC2.EbsInstanceBlockDevice>;
